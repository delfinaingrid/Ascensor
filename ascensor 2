...
masa_cabina = 350  # Masa medida en kg

masa_persona = 75  # Masa medida en kg

numero_personas = 6  # Cantidad de pasajeros
...
print('-------------------------------------')
print('La fuerza utilizada es ', fuerza, '[N]')
print('------------------- ------------------')
print('La masa utilizada es ', masa, '[Kg]')
print('-------------------------------------')
print('La altura utilizasa es ', altura, '[m]')
print('-------------------------------------')
print('La aceleracion maxima es ', acel_maxima, '[m/s^2]')
print('-------------------------------------')


###Funciones posicion (f), velocidad (f derivada) y aceleracion (f derivada segunda)
def posicion(t):
...
def f(x):
    fa = posicion(x) - posicion(tiempoEn30Porciento)  #funcion g
    df = velocidad(x)
    return fa, df
...
MAXITER_N = 60  # maxima cantidad de iteraciones para Newton Raphson
